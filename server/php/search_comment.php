...
<div class="container">
  ...
  $sql = "SELECT * FROM `comments` WHERE `body` LIKE '%$search_get%'";
  ...
  while ($select_while = mysqli_fetch_assoc($select)){
	  ?>
	  <br>
	  <h4><li><a style = "color: grey" href ="/php/book.php?id=<?= $select_while['book_id'] ?>"> <?php echo $select_while['body']; ?></a></li></h4>
